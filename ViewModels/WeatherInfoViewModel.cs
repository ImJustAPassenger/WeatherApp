            ...
            var regions = new Dictionary<string, List<string>>
{
    ...
    { "Piemonte", new List<string> { "Torino", "Novara", "Alessandria", "Asti", "Cuneo", "Biella", "Verbania", "Vercelli" } },
    ...
    { "Sicilia", new List<string> { "Palermo", "Catania", "Messina", "Siracusa", "Trapani", "Ragusa", "Agrigento", "Caltanissetta", "Enna" } },
